...
import {
  setCarouselState,
  onSlickCarouselChange,
  onUserCarouselChange,
...
export default function (context) {
  ...
  $('body').on('click', '.quickview', (event) => {
    ...
    const handleDropdownExpand = ({ currentTarget }) => {
      ...
      return modal.$modal.one(ModalEvents.close, () =>
        $dropdownMenu.off('opened.fndtn.dropdown', handleDropdownExpand),
      );
    };
