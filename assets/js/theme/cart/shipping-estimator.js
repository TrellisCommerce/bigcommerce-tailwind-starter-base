...
export default class ShippingEstimator {
  ...
  initFormValidation() {
    ...
    $('.shipping-estimate-submit', this.$element).on('click', (event) => {
      ...
      if (
        $(`${this.shippingEstimator} select[name="shipping-country"]`).val()
      ) {
    ...
    this.shippingValidator.add([
      {
        ...
        validate: (cb) => {
          ...
          const $ele = $(
            `${this.shippingEstimator} select[name="shipping-state"]`,
          );
